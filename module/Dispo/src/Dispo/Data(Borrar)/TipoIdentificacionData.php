...
class TipoIdentificacionData
{
	...
	*/
     ...
     * @var string
	*/
    protected $codigo_sri;

	/**
     * @var string
	*/
    protected $codigo_homologado;
	...
	*/
	...
	public function getCodigoSRI()			{return $this->codigo_sri;}
	public function getCodigoHomologado()	{return $this->codigo_homologado;}
	...
	public function setCodigoSRI($valor)			{$this->codigo_sri 				= $valor;}	
	public function setCodigoHomologado($valor)		{$this->codigo_homologado 		= $valor;}
