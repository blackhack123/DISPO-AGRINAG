...
*/					
	...
	function exportarExcelDispoGrupoAction()
	{
		try
		{
			...
			$result = $GrupoDispoCabBO->generarExcel($condiciones);
	...
	function exportarSkypeCajasDispoGrupoAction()
	{
		try
		{
			...
			//$opcion_formato_archivo	= $request->getQuery('opcion_formato_archivo', "CAJA-NUEVA-VS-ROTACION");
			$color_ventas_id  		= '';
			$calidad_variedad_id	= '';
	...
	function exportaExcelInternoCajasDispoGrupoAction()
	{
		try
		{
			...
			$result = $GrupoDispoCabBO->generarExcelInternoCajas($condiciones);
	...
	}//end function exportaExcelInternoCajasDispoGrupoAction
